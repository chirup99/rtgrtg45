...
export function DemoHeatmap({ onDateSelect, selectedDate, onDataUpdate, onRangeChange, highlightedDates, isPublicView, tradingDataByDate, onSelectDateForHeatmap }: DemoHeatmapProps) {
  ...
  return (
    <div className="flex flex-col gap-2 p-3 rounded-md border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 select-none overflow-visible">
      <div className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 flex items-center justify-between gap-2">
        <div>Trading Calendar {new Date().getFullYear()}</div>
